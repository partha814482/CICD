...
# Load Data
dataset = pd.read_csv(r"C:\Users\HP\OneDrive\Documents\SENAPATI SIR FSDS NOTE\NOVEMBER MONTH DS NOTE\5th- CICD Pipeline, Web Scrapping\5th- CICD Pipeline, Web Scrapping\cicd workflows\iris.csv")
